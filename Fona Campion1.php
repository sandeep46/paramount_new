							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab1">
									<div class="row">										
										<div class="col-md-12">
											<div class="content">
												<h2>USER BENEFITS</h2><br>
												<p>
                                                <ul style="">
                                            <li>Available for right- and left-hand use</li>
<li>Integrated LCD Display and X-ray Viewer</li>
<li>Precise Vision</li>
<li>Modern Design, Superior Ergonomics</li>
<li>Smart Hygiene</li>
<li>Flexibility that Fits</li>
<li>Advanced Anti-Collision System</li>
</ul>
                                               ...
                                               <img src="Techdetailscampion.PNG"/>
											</div>
										</div>
									</div>
								</div>
