			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Create Sub Category2 </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="insert_subcat2.php" enctype="multipart/form-data" method="post">						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Sub Category 2</label>
							  <div class="controls">
						<input type="text" class="span6 typeahead" id="typeahead" name="sname1"  data-provide="typeahead" data-items="4"/>
