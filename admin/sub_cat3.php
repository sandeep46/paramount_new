			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Sub Category3</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="insert_subcat3.php" enctype="multipart/form-data" method="post">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Sub Category 3</label>
							  <div class="controls">
						<input type="text" class="span6 typeahead" id="typeahead" name="scat3" data-provide="typeahead" data-items="4"/>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" name="scat_name">
									<?php
    include("config1.php");
...
?>
                             ...
                             <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" name="sname">
									<?php
    include("config1.php");
...
?>
                              ...
                              <div class="control-group">
								<label class="control-label" for="selectError3">Main Category</label>
								<div class="controls">
								  <select id="selectError3" name="scat">
								<?php
    include("config1.php");
